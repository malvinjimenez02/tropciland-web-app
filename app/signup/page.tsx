        ...
        <div className="w-full max-w-[360px]">
          ...
          {submitted ? (
            <div className="text-center">
              ...
              <h2 className="mb-2 text-xl font-semibold text-gray-900">Cuenta creada</h2>
              <p className="mb-6 text-sm text-gray-500">
                Te enviamos un correo de confirmación. Revisa tu bandeja de entrada.
              </p>
              <Link
                href="/login"
                className="flex h-11 w-full items-center justify-center rounded-lg bg-[#2d5c3c] text-sm font-semibold text-white transition hover:bg-[#366747]"
              >
                Ir a iniciar sesión
              </Link>
            </div>
            ...
            <>
              ...
              <p className="mb-8 text-center text-sm text-gray-500">
                Regístrate para empezar a gestionar tus pedidos
              </p>
              ...
              <div className="space-y-2.5">
                ...
                >
                  <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
                    ...
                    <path d="M4.476 10.18A4.507 4.507 0 014.24 8.5c0-.58.1-1.144.236-1.68V4.962H2.082A7.497 7.497 0 001 8.5c0 1.21.29 2.355.802 3.37l2.674-1.69z" fill="#FBBC05"/>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="confirm" className="mb-1.5 block text-xs font-medium text-gray-600">
              ...
              <p className="mt-6 text-center text-xs text-gray-500">
                ¿Ya tienes cuenta?{' '}
                <Link href="/login" className="font-medium text-[#2d5c3c] hover:underline">
                  Inicia sesión
                </Link>
              </p>
